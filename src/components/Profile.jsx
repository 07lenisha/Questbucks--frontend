...
import { fetchuserAccount, updateUserProfile } from "../slices/UserSlice";
...
export default function Profile() {
  ...
  const { redemptions, loading: redemptionLoading } = useSelector(
    (state) => state.redeem
  );
  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      ...
      {data?.role === "company" ? (
        <>
          <h2 className="text-4xl font-extrabold mb-8 text-blue-900">
            🎯 Company Dashboard
          </h2>
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {quizes.map((quiz) => (
                  ...
                  >
                    ...
                    <button
                      onClick={() =>
                        navigate(`/company/quiz/${quiz._id}/attempts`)
                      }
                      className="mt-4 inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-sm font-semibold rounded-md shadow-md hover:from-blue-600 hover:to-indigo-700 transition duration-300"
                    >
                      🔍 View Answers
                    </button>
                  </div>
                ...
                {redemptions.map((item, idx) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm">
                        User: {item.user_id?.name || "Unknown User"}
                      </p>
                    </div>
        ...
        <>
          <h2 className="text-4xl font-extrabold mb-8 text-purple-900">
            👤 {data.role} Dashboard
          </h2>
