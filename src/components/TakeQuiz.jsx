            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {paginatedQuizzes.map((quiz) => (
                <div
                  ...
                  role="button"
                  tabIndex={0}
                  onKeyDown={(e) => e.key === 'Enter' && handleSelectQuiz(quiz._id)}
                >
                ...
                {currentQuiz.questions[currentQuestionIndex].options.map(
                  (option, oIdx) => (
                    ...
                    >
                      ...
                      />
                      <span className="select-none text-lg">{option.option_text}</span>
                    </label>
                  )
                )}
              </div>
          ...
          <div className="mt-8 space-y-8">
            ...
            {redemptionCode && (
              <div className="max-w-xl mx-auto p-8 bg-gradient-to-tr from-blue-300 via-purple-300 to-pink-300 rounded-3xl shadow-2xl text-center animate-fadeIn">
                ...
                <button
                  onClick={() =>
                    navigator.clipboard.writeText(redemptionCode.redemption_code)
                  }
                ...
                <div className="mt-6 text-left text-white space-y-2 font-semibold text-lg drop-shadow-md">
                  <p>
                    Status: <span className="font-bold">{redemptionCode.status}</span>
                  </p>
                  <p>
                    Company:{' '}
                    <span className="font-bold">{redemptionCode.company_name}</span>
                  </p>
